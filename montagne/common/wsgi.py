...
CONF.register_cli_opts([
    cfg.StrOpt('wsgi-host', default='', help='wsgi listen host'),
    cfg.IntOpt('wsgi-port', default=8080, help='wsgi listen port')
])
...
class WSGIServer(hub.WSGIServer):
    def __init__(self, application, **config):
        super(WSGIServer, self).__init__((CONF.wsgi_host, CONF.wsgi_port),
                                         application, **config)
